...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6374589488:AAHkqIz4M7J8ZPSYCNkZAia_9vaCYsjUtlE")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002202525645"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002207171276"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "1828405916").split()):
        ADMINS.append(int(x))
except ValueError:
